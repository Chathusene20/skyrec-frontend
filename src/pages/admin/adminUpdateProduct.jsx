...
export default function UpdateProductPage() {
  ...
  const [altName, setAltNames] = useState(location.state. alternates .join(","));
  const [description, setDescription] = useState(location.state.description);
  const [images, setImages] = useState([]);
  const [price, setPrice] = useState(location.state.price);
  const [labelledPrice, setLabelledPrice] = useState(location.state.labelledPrice);
  const [catergory, setCategory] = useState(location.state.category);
  ...
  async function updateProduct(){
    ...
    const alternativeNames = altName.split(",");
     ...
     const product = {
         ...
         toast.success("Product updated added successfully");
