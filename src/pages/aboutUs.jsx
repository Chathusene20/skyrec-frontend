...
export default function AboutPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#06202B] text-white">
      ...
      <section
        className="relative min-h-[75vh] flex items-center bg-[url('/bg.jpg')] bg-cover bg-center"
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-16 w-full">
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4 mt-9">
              ...
              <Link
                to="/products"
                className="px-7 py-3 rounded-xl bg-accent text-white font-semibold text-lg hover:scale-105 transition duration-300"
              >
                Explore Products
              </Link>
              ...
              <Link
                to="/"
                className="px-7 py-3 rounded-xl border border-white/30 bg-white/10 backdrop-blur-md text-white font-semibold text-lg hover:bg-white/20 transition duration-300"
              >
                Back to Home
              </Link>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl border border-white/20 bg-white/10 backdrop-blur-2xl shadow-xl p-10">
                ...
                <p className="text-center text-2xl md:text-3xl font-semibold leading-relaxed">
      ...
      <section className="py-24 px-6 bg-black/20">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="mt-8 text-xl md:text-2xl text-white/75 leading-9 max-w-4xl mx-auto">
      ...
      <section className="py-24 px-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-5">
            ...
            <div className="group rounded-3xl border border-white/20 bg-white/10 backdrop-blur-xl p-7 text-center hover:bg-white/15 hover:-translate-y-2 transition duration-300">

              <div className="w-16 h-16 mx-auto rounded-2xl bg-accent/20 flex items-center justify-center mb-5">
      ...
      <section className="py-24 px-6 bg-black/20">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="rounded-3xl border border-white/20 bg-white/10 backdrop-blur-2xl p-8 hover:-translate-y-2 transition duration-300">
      ...
      <section className="py-24 px-6">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="rounded-3xl border border-white/20 bg-white/10 backdrop-blur-2xl shadow-xl p-10 md:p-16 text-center">
            ...
            <p className="mt-7 text-white/70 text-lg leading-8 max-w-3xl mx-auto">
            ...
            <p className="mt-5 text-white/70 text-lg leading-8 max-w-3xl mx-auto">
      ...
      <section
        className="relative py-28 px-6 bg-[url('/bg.jpg')] bg-cover bg-center"
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <Link
            to="/products"
            className="inline-block mt-8 px-9 py-4 rounded-xl bg-accent text-white font-semibold text-lg hover:scale-105 transition duration-300"
          >
            Shop Now
          </Link>
      ...
      <footer className="border-t border-white/10 bg-[#041820]">
